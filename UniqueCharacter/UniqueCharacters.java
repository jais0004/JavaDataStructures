public class UniqueCharacter{
    //This method has Big(O) of O(n) as we are having only one for loop, there is alternate solution which will check each char to all other char in string which has permonace of O(n^2)
